...
public class ArabicBASICParser extends Parser {
  ...
  public final SimpleAssignmentContext simpleAssignment() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        ((SimpleAssignmentContext) _localctx)
            .name.add(((SimpleAssignmentContext) _localctx).IDENTIFIER);
        setState(90);
        _errHandler.sync(this);
        _la = _input.LA(1);
        while (_la == T__1) {
  ...
  public final PrintContext print() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _errHandler.sync(this);
        _la = _input.LA(1);
        while (_la == T__1 || _la == T__22) {
          {
            {
              setState(175);
              ((PrintContext) _localctx)._tset334 = _input.LT(1);
              _la = _input.LA(1);
              if (!(_la == T__1 || _la == T__22)) {
                ((PrintContext) _localctx)._tset334 = (Token) _errHandler.recoverInline(this);
              } else {
                if (_input.LA(1) == Token.EOF) matchedEOF = true;
                _errHandler.reportMatch(this);
                consume();
              }
              ((PrintContext) _localctx).spacer.add(((PrintContext) _localctx)._tset334);
              setState(176);
              expression(0);
            }
          }
  ...
  public static class ModulusContext extends ExpressionContext {
    ...
    public ModulusContext(ExpressionContext ctx) {
      copyFrom(ctx);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof ArabicBASICVisitor)
        return ((ArabicBASICVisitor<? extends T>) visitor).visitModulus(this);
      else return visitor.visitChildren(this);
    }
  }
                ...
                case 2:
                  {
                    ...
                    setState(237);
                    ((ModulusContext) _localctx).op = match(T__41);
                    setState(238);
                    expression(7);
                  }
                  break;
