        ...
        while (_la == T__15 || _la == T__16) {
          {
            {
              setState(124);
              ((PrintContext) _localctx)._tset218 = _input.LT(1);
              _la = _input.LA(1);
              if (!(_la == T__15 || _la == T__16)) {
                ((PrintContext) _localctx)._tset218 = (Token) _errHandler.recoverInline(this);
              } else {
                if (_input.LA(1) == Token.EOF) matchedEOF = true;
                _errHandler.reportMatch(this);
                consume();
              }
              ((PrintContext) _localctx).spacer.add(((PrintContext) _localctx)._tset218);
              setState(125);
              expression(0);
            }
          }
