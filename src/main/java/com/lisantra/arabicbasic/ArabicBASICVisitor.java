...
public interface ArabicBASICVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ArabicBASICParser#singleLineConditional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSingleLineConditional(ArabicBASICParser.SingleLineConditionalContext ctx);
	/**
	 ...
	 * labeled alternative in {@link ArabicBASICParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code mathFunction}
	 * labeled alternative in {@link ArabicBASICParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code exponentation}
	 * labeled alternative in {@link ArabicBASICParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code atomicBoolean}
	 * labeled alternative in {@link ArabicBASICParser#booleanExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code comparitiveBoolean}
	 * labeled alternative in {@link ArabicBASICParser#booleanExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code negatingBoolean}
	 * labeled alternative in {@link ArabicBASICParser#booleanExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code nestedBoolean}
	 * labeled alternative in {@link ArabicBASICParser#booleanExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * labeled alternative in {@link ArabicBASICParser#variable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
