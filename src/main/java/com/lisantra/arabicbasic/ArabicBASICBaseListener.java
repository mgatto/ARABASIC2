...
/**
 * This class provides an empty implementation of {@link ArabicBASICListener}, which can be extended
 * to create a listener which only needs to handle a subset of the available methods.
 */
public class ArabicBASICBaseListener implements ArabicBASICListener {
  /**
   * {@inheritDoc}
   *
   ...
   */
  @Override
  public void enterStatement(ArabicBASICParser.StatementContext ctx) {}
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation does nothing.
   */
  @Override
  public void exitStatement(ArabicBASICParser.StatementContext ctx) {}
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation does nothing.
   ...
   */
  @Override
  public void exitAssignment(ArabicBASICParser.AssignmentContext ctx) {}
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation does nothing.
